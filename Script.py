class script(object):
    START_TXT = """<b> 𝓗𝓮𝓵𝓵𝓸 𝓓𝓮𝓪𝓻 {}</b>

𝑰 𝒎 𝑨𝒏 𝑨𝒖𝒕𝒐 𝑭𝒊𝒍𝒕𝒆𝒓 𝑽𝟐 + 𝑴𝒐𝒗𝒊𝒆 𝑺𝒆𝒂𝒓𝒄𝒉 + 𝑴𝒂𝒏𝒖𝒂𝒍 𝑭𝒊𝒍𝒕𝒆𝒓 𝑩𝒐𝒕. 𝑰 𝑪𝒂𝒏 𝑷𝒓𝒐𝒗𝒊𝒅𝒆 𝑴𝒐𝒗𝒊𝒆𝒔 𝑰𝒏 𝑻𝒆𝒍𝒆𝒈𝒓𝒂𝒎 𝑮𝒓𝒐𝒖𝒑𝒔. 𝑰 𝑪𝒂𝒏 𝑨𝒍𝒔𝒐 𝑨𝒅𝒅 𝑭𝒊𝒍𝒕𝒆𝒓𝒔 𝑰𝒏 𝑻𝒆𝒍𝒆𝒈𝒓𝒂𝒎 𝑮𝒓𝒐𝒖𝒑𝒔.  𝑱𝒖𝒔𝒕 𝑨𝒅𝒅 𝑴𝒆 𝑻𝒐 𝒀𝒐𝒖𝒓 𝑮𝒓𝒐𝒖𝒑 𝑨𝒏𝒅 𝑬𝒏𝒋𝒐𝒚!  𝒀𝒐𝒖 𝑪𝒂𝒏 𝑨𝒍𝒔𝒐 𝑪𝒉𝒆𝒄𝒌 𝑶𝒖𝒕 𝑴𝒚 𝑬𝒙𝒕𝒓𝒂 𝑭𝒆𝒂𝒕𝒖𝒓𝒆𝒔 𝒗𝒊𝒂 𝑯𝒆𝒍𝒑 !
...
"""
    ...
    ABOUT_TXT = """✯ MY: 
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/sigma_male_007>Ꭰҽѵ</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: (𝙿𝚈)(𝚁𝙾)(𝙶𝚁)(𝙰𝙼)  
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: (𝙿𝚈𝚃𝙷𝙾𝙽) (𝟹)
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: (𝙼𝙾𝙽)(𝙶𝙾) (𝙳𝙱)
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 口长丅乇丅口 
✯ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂: 𝓿2.0.1 [𝙱𝙴𝚃𝙰]"""

    SOURCES_TXT = """Contact Dev"""

    SOURCE_TXT = """Tʜɪs Is Aɴ Oᴩᴇɴ-Sᴏᴜʀᴄᴇ Pʀᴏᴊᴇᴄᴛ Bʏ @z_harbour</b>

- 100﹪ Cᴏᴅᴇᴅ Bʏ <a href=https://t.me/sigma_male_007>Ꭰҽѵ</a></b>
...
<b>Fɪʀsᴛ Jᴏɪɴ Tʜɪs Gʀᴏᴜᴩ » @blackest_harbour</b>

<b>Sᴇɴᴅ Yᴏᴜ Wᴀɴᴛ Mᴏᴠɪᴇs Oʀ Sᴇʀɪᴇs Nᴀᴍᴇ Wɪᴛʜ Cᴏʀʀᴇᴄᴛ Sᴩᴇʟʟɪɴɢ</b>

<b>Aɴᴅ Bᴏᴛ Wɪʟʟ Sᴇɴᴅ Yᴏᴜ Asᴋᴇᴅ Fɪʟᴇ</b>

<b>Hᴏᴡ Tᴏ Oᴩᴇɴ Bᴏᴛ Sᴇɴᴅᴇᴅ Fɪʟᴇ Lɪɴᴋ. » <a href=https://t.me/mdisk_bots>ᴛᴜᴛᴏʀɪᴀʟ</a>.﹤/b>"""
