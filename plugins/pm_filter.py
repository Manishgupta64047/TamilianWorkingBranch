...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("🌝How to Download 🌝", url=f"https://t.me/mdisk_bots/23")
    ])
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer(' ˆ°•Here we Go•°ˆ ')
            else:
                await query.message.edit_text(
                    "Iᴀᴍ Nᴏᴛ Cᴏɴɴᴇᴄᴛᴇᴅ Tᴏ Aɴʏ Gʀᴏᴜᴩ \nCʜᴇᴄᴋ /connections Oʀ Cᴏɴɴᴇᴄᴛ Tᴏ Aɴʏ Gʀᴏᴜᴩ",
                    quote=True
                )
                return await query.answer(' ˆ°•Go Gone Going•°ˆ ')
        ...
        return await query.answer(' ˆ°• Okay Fine Dear •°ˆ ')
        ...
        return await query.answer(' ˆ°•Long Live Bot Market•°ˆ ')
        ...
        return await query.answer(' ˆ°•Bot Market Fed•°ˆ ')
        ...
        return await query.answer(' ˆ°• Okay Nat A Problem•°ˆ ')
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await client.send_photo(chat_id=query.from_user.id, photo='https://graph.org/file/6efe4d0d0f86e4990e854.jpg', caption = f"<b>📕Nᴀᴍᴇ ➠ : <code>{files.file_name}</code> \n\n🔗Sɪᴢᴇ ➠ : {get_size(files.file_size)}</b>", 
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🧩 Share Bot', url=f"https://t.me/share/url?url=t.me/{temp.U_NAME}")
        ], [
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📥 Download Help', callback_data='info')
        ],[
            InlineKeyboardButton('🏠 Home', callback_data='start'),
        ...
        buttons = [[
            InlineKeyboardButton('🔙 Back', callback_data='mods')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('😳 Cʀᴇᴀᴛᴏʀ 😳', url='https://t.me/mdisk_bots')
        ], [     
            InlineKeyboardButton('📞 Cᴏɴᴛᴀᴄᴛ 📟', url='https://t.me/blackest_harbour')
        ], [  
            InlineKeyboardButton('‹‹‹ Bᴀᴄᴋ', callback_data='about')
        ], [
        ]]
    ...
    await query.answer(' ˆ°•Bot Is Advanced•°ˆ ')
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("😌How To Download 😌", url=f"https://t.me/mdisk_bots/22")
    ])
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply("I couldn't find anything related to that. Check your spelling Request Series Like This Lucifer S01 E14 & Movies Like This KGF 2022,Kgf Hindi")
        await asyncio.sleep(8)
        await k.delete()
        return
