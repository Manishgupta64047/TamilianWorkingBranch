...
# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 50))
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL','-1001605409121'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'z_harbour')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "False")), False)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<code> Check Out Audio Language By Sending This File To File To Link Bots! Stream Then Download via Team @z_harbour </code>")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001989291803')).split()]
